...
import static uk.co.gencoreoperative.fileutils.SearchUtils.iterateBottomUp;
import static uk.co.gencoreoperative.fileutils.SearchUtils.iterateTopDown;
...
import uk.co.gencoreoperative.fileutils.SearchUtils.Search;
...
public class SearchUtilsTest {
	...
	public void testIterateTopDownStartAtRightPlace() {
		...
		File test = mockFile("a");
		final List<String> names = new LinkedList<String>();
		iterateTopDown(test, new Action(){
			@Override
			public void perform(File file) {
				names.add(file.getName());
			}
